...
void init()
{
    ...
    window = SDL_CreateWindow("Tutorial 005", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
...
void loadMedia()
{
    imageSurface = loadSurface(qApp->applicationDirPath().append(QStringLiteral("/stretch.bmp")));
}
...
int main(int argc, char* argv[])
{
    ...
    while (!quit) {
        ...
        SDL_BlitScaled(imageSurface, nullptr, windowSurface, &stretchRect);
