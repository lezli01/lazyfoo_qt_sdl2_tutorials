...
void init()
{
    ...
    window = SDL_CreateWindow("Tutorial 015", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
...
void loadMedia()
{
    texture = new LTexture(renderer, qApp->applicationDirPath().append(QStringLiteral("/arrow.png")));
}
